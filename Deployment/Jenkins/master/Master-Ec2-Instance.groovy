pipeline {
    ...
    parameters {
        ...
        string(name: 'AppVolumeSize', defaultValue: '30', description: 'Size in GB of the EBS volume to create. Ignored if "AppVolumeDevice" is blank')
        ...
        string(name: 'InstanceType', defaultValue: 'm4.large', description: 'Amazon EC2 instance type')
