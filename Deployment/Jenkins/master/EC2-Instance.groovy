pipeline {
    ...
    parameters {
        ...
        string(name: 'AppVolumeMountPath', defaultValue: '/var/lib/jenkins', description: 'Filesystem path to mount the extra app volume. Ignored if "AppVolumeDevice" is false')
        ...
        string(name: 'JenkinsRpmName', description: 'Name of Jenkins RPM to install. Include release version if "other-than-latest" is desired. (Examples: jenkins, jenkins-2.*, jenkins-X.Y.Z, etc.)')
